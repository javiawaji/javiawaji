...
<p align="center"> $\text{\color{#FFFFFF}٫٫}$ &emsp; $\text{\color{#D5C5C8}I}$ $\text{\color{#9EA2A5}block}$ $\text{\color{#D5C5C8}freely}$
<p align="center"> $\text{\color{#D5C5C8}c+h w/}$ $\text{\color{#FFFFFF}friends}$ $\text{\color{#D5C5C8}+ friends of friends}$ &emsp; $\text{\color{#9EA2A5}no inspo}$ &ensp; $\text{\color{#FFFFFF}!!}$
